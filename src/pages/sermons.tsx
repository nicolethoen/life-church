...
export default () => (
    <div className="lc-sermons">
        <h2 className="lc-sermons__date">Oct 25th, 2020 - A Life Worth Living</h2>
        <div className="lc-sermons__video">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/X-XcdLaiijs" frameBorder="0"
