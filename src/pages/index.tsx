...
export default () => {
    const worshipSongs = (
        <>
            <div className="lc-worship-song"><a href="https://www.youtube.com/watch?v=eRux8NlvEYo" target="_blank">Thy Mercy</a></div>
            <div className="lc-worship-song"><a href="https://www.youtube.com/watch?v=sgmhTPi0Zi8" target="_blank">Run to you</a></div>
            <div className="lc-worship-song"><a href="https://www.youtube.com/watch?v=7w3DXMkyj7Q" target="_blank">O, For a Thousand Tongues to Sing</a></div>
        </>
    );

    const scriptureReading = <a href="https://www.biblegateway.com/passage/?search=Jonah+1%3A1-16&version=ESV" target="_blank">Jonah 1:1-16</a>;
    ...
    return (
        <div className="lc-order-of-worship">
            ...
            <div className="lc-order-of-worship__faithlife-bulletin">
                Follow along with the sermon slides on <a href="https://faithlife.com/8613551/bulletins/67349638" target="_blank">Faithlife</a>
            </div>
