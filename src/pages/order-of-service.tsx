...
export default () => {
    ...
    return (
        <div className="lc-order-of-worship">
            ...
            <ServiceItem person="Julia Wu" subtext={<ScriptureLink reference="" text={scriptureReading} />}>Scripture Reading</ServiceItem>
            <ServiceItem person="Dan Kasey" subtext='' sermonNotes={sermonNotes}>Sermon</ServiceItem>
