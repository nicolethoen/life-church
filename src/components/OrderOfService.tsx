...
export default () => {
    ...
    const worshipSongs = (
        <>
            ...
            <div className="lc-worship-song">Cornerstone</div>
            <div className="lc-worship-song">Open the Eyes of My Heart</div>
        </>
    );
    ...
    return (
        <div className="lc-order-of-worship">
            <h2 className="lc-order-of-worship__date">May 16th, 2021</h2>
            <ServiceItem>Welcome</ServiceItem>
            <ServiceItem person="Dan Kasey" subtext="Psalm 42:1-5">Call to Worship & Opening Prayer</ServiceItem>
            ...
            <ServiceItem person="Colbys">Scripture Reading</ServiceItem>
            <ServiceItem person="Dan Kasey">Sermon</ServiceItem>
            <ServiceItem person="Dawn Provost" subtext={closingSong}>Closing Song</ServiceItem>
